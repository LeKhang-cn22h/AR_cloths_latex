...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{graphics/main/chapter3/profile.jpg}
...
\subsection{Giao diện chuyển giao diện sang Stripe để thanh toán}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{graphics/main/chapter3/Stripe.jpg}
    \caption{Giao diện chuyển giao diện sang Stripe để thanh toán}
    \label{fig:Stripe_ui}
\end{figure}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{graphics/main/chapter3/tinh_Stripe.jpg}
    \caption{Giao diện nhập tài khoản thanh toán}
    \label{fig:payment_account_ui}
\end{figure}
Khi người dùng lựa chọn thanh toán trực tuyến qua Stripe, hệ thống sẽ chuyển hướng đến cổng thanh toán của Stripe. Giao diện thanh toán được thiết kế theo tiêu chuẩn bảo mật, cung cấp nhiều phương thức thanh toán khác nhau như thẻ nội địa, thẻ quốc tế và các hình thức thanh toán điện tử.
