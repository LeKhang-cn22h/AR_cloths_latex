...
\subsection{Giao diện thử đồ thực tế ảo (AR)}
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{graphics/main/chapter3/ar.png}
    \caption{Giao diện thử đồ thực tế ảo (AR)}
    \label{fig:ar_tryon_ui}
\end{figure}

Giao diện thử đồ thực tế ảo (AR) mang đến cho người dùng trải nghiệm mua sắm tương tác và trực quan. Thông qua camera của thiết bị, hệ thống sẽ nhận diện và phủ các mô hình trang phục 3D (như áo, quần, phụ kiện) lên cơ thể người dùng theo thời gian thực. Trong hình minh họa, người dùng đang ướm thử một chiếc áo khoác với độ khớp sinh động và tự nhiên.
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{graphics/main/chapter3/admin_donhang.png}
